 ...
 */
export function writerModelForCategory(categoria) {
 ...
 */
export function estimateMonthlyApiCost(articlesPerDay) {
    ...
    const historicalCost = daysPerMonth * (estimateCost('claude-sonnet-4-20250514', 1800, 2000) + // ~1.400 palabras
